...
class MainWindow(QMainWindow):
    def __init__(self):
       ...
       # Bildschirmgröße ermitteln
        ...
        self.param_inputs = {}
        self.params = {
            "T (periods)": 2, "n (products)": 1, "m (factors)": 2, "alpha (0,1,2)": 1
        }
        ...
        # Run Solver Button
        self.run_button = QPushButton("Run Circular Master Production Schedule")
    ...
    def generate_fields(self):
        ...
        alpha = int(self.param_inputs["alpha (0,1,2)"].text())
